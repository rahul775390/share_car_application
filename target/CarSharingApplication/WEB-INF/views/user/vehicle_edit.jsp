...
<head>
    ...
    <title>Edit Vehicle - CarSharing</title>
    <!-- Bootstrap 5 CSS -->
...
<body>
    ...
    <main class="container form-container mb-5">
        <div class="bg-white p-4 border rounded-4 shadow-sm">
            ...
            <p class="text-muted mb-4">Modify your vehicle details below.</p>
            ...
            <form action="${pageContext.request.contextPath}/vehicles/edit" method="POST" class="needs-validation" novalidate>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="year" name="year" value="${vehicle.year}" min="1900" max="2027" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="seatingCapacity" name="seatingCapacity" value="${vehicle.seatingCapacity}" min="1" max="20" required>
